...
import { Home, User, Code, FolderKanban, Mail, LogOut, Menu, X } from "lucide-react"
...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { name: "About Section", path: "/admin/about", icon: <User size={18} /> },
    { name: "Skills Section", path: "/admin/skills", icon: <Code size={18} /> },
    { name: "Projects Section", path: "/admin/projects", icon: <FolderKanban size={18} /> },
    { name: "Contact Section", path: "/admin/contact", icon: <Mail size={18} /> },
  ]
