...
const CreativeNavbar = ({ currentSection, onSectionChange }: CreativeNavbarProps) => {
  ...
  return (
    ...
    >
          ...
          {navItems.map((item) => (
            <motion.button
              ...
              className={`relative text-sm font-medium transition-colors ${
                currentSection === item.id ? "text-amber-400" : "text-white hover:text-amber-400"
              }`}
            >
      ...
      {/* Mobile Menu */}
      <div id="mobile-menu" className="hidden md:hidden bg-black/95 backdrop-blur-md">
          ...
          {navItems.map((item) => (
            <button
              ...
              className={`py-3 text-center text-lg font-medium ${
                currentSection === item.id ? "text-amber-400" : "text-white"
              }`}
            >
              {item.label}
            </button>
