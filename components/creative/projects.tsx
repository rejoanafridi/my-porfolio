            ...
            >
              ...
              >
                <div className="relative h-64 md:h-80">
                  <Image
                    src={data.projects[activeProject].image || "/placeholder.svg"}
                ...
                <div className="p-6 md:p-8">
                  ...
                  <p className="text-gray-300 mb-6">{data.projects[activeProject].description}</p>

                  <div className="flex flex-wrap gap-3 mb-8">
                    {data.projects[activeProject].techStack.map((tech, index) => (
                      <span
                        key={index}
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Button variant="outline" className="border-amber-500 text-amber-400 hover:bg-amber-500/10" asChild>
                      <a
                        href={data.projects[activeProject].githubLink}
                        target="_blank"
                    ...
                    >
                      <a
                        href={data.projects[activeProject].demoLink}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2"
                      >
